...
manager.create_planet(description='mercury', x_position=7.376*10**12, y_position=7.376*10**12-5.791*10**10, mass=3.285*10**23, x_speed=33490, y_speed=33490)
...
manager.create_planet(description='earth', x_position=7.376*10**12, y_position=7.376*10**12-1.096*10**11, mass=5.972*10**24, x_speed=21058, y_speed=21058)
