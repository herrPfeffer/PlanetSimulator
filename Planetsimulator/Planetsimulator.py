...
creator.CreatePlanet(description='planet2', xPosition=2, yPosition=3, mass=300, speed=1)
creator.CreatePlanet(description='planet2', xPosition=3, yPosition=4, mass=300, speed=1)
